    ...
    return (
        <div className={styles.pokemonSection}>
            ...
            <Container>
                ...
                <p><em>"One of the first assignments we were given in my course was to create a console based game with simple JavaScript. <br/>I thought that'd be incredibly boring, so i went and made a browsergame with visuals, fully functional pokémon battles instead." - Alexander Hallgren</em></p>
            </Container>
        </div>
    )
}
